        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{route('new_cat')}}">New Category</a></li>
                        <li><a href="{{route('show_cat')}}">Show Category</a></li>
                        <li><a href="{{route('delete')}}">Delete Category</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{route('new_book')}}">New Book</a></li>
                        <li><a href="{{route('show_book')}}">Show Book</a></li>
                        <li><a href="{{route('updateBook')}}">Update Book</a></li>
                        <li><a href="{{route('deleteBook')}}">Delete Book</a></li>
            ...
            <ul class="nav navbar-nav navbar-left">
                @if(!Auth::User())
                    ...
                    <li><a href="{{route('register')}}"><span class="glyphicon glyphicon-registration-mark">Register</span> </a></li>
                @else
